...
import ApplyPartyList from './apply-partylist';

export const getColumns = (userHasApplied: boolean): ColumnDef<PartyWithStatus>[] => [
  {
  ...
  },
  {
	...
	cell: ({ row }) => {
	  ...
	  return <ApplyPartyList party={actions} userHasApplied={userHasApplied} />;
	},
  },
];
