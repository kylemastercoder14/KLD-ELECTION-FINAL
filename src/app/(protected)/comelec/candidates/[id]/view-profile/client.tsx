...
const ViewProfile = ({
  ...
  const handleStatusUpdate = (status: "APPROVED" | "REJECTED") => {
    startTransition(async () => {
      const result = await updateCandidateStatus(initialData.id, status);
      if (result.success) {
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <Button
                        ...
                        onClick={() =>
                          router.push(
                            `/comelec/party-list/${party.id}/view-details`
                          )
                        }
                      >
                ...
                <CardContent className="p-6">
                  <div className="flex flex-wrap gap-4">
                    <Button
                      ...
                      className="flex-1 min-w-[200px] border-green-600 hover:text-green-600 cursor-pointer text-green-600 hover:bg-green-50"
                    >
                      {isPending ? (
                    ...
                    <Button
                      ...
                      variant="outline"
                      className="flex-1 min-w-[200px] border-red-600 cursor-pointer hover:text-red-600 text-red-600 hover:bg-red-50"
                    >
                      {isPending ? (
                        <Loader2 className="h-4 w-4 mr-2 animate-spin" />
                      ) : (
